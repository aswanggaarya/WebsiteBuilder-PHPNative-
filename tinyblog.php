        		...
        		<div class="row">
        			<div class="col-lg text-center" style="margin-top: 2%;">
			        	<form action="" method="post">
				    		<?php  
				                // $query = ("SELECT isi FROM menu");
				                $sql = "SELECT `isi` FROM `template` WHERE id_tem = 3";
								...
								$koneksi->close();
				        	?>
				        	<a href="blog.php"><button type="button" class="btn btn-link" style="margin-top: 2%; ">Back</button></a>
